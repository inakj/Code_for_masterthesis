...
class ULS_prestress:
    ...
    def __init__(self, material, load, cross_section, time_effect):
        ...
        '''
        self.eps_diff = self.calculate_strain_diff(self,load.sigma_p_max,material.Ep,time_effect.loss_percentage)
        ...
        self.M_control = self.control_moment(load.M_ULS,load.M_prestress)
