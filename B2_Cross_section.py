...
class Cross_section:
    ...
    def __init__(self,width: float, height: float, nr_bars: int, bar_diameter: float, 
        ...
        '''Args:
            ...
            bar_diameter(float):  diameter of each longitudinal reinforcement bar, defined by user [mm]
            stirrup_diameter(float):  diameter of each reinforcement stirrup, defined by user [mm]
        ...
        Returns:
            ...
            I(float):  second moment of inertia [mm4]
    ...
    def get_c_min_dur(self,exposure_class: int, c_min_b: float)-> float:
        ''' Function that finds c_min_dur accordning to EC2 table NA.4.4N, assumed 50 years.
        Args:
    ...
    def calculate_cnom(self,c_min_b: float, c_min_dur: float)-> float:
        ''' Function that finds cnom accordning to EC2 4.4.1.1, 4.4.1.2 and 4.4.1.3. 
        Args:
            c_min_b(float):  smallest nominal cover because of bonding [mm]
            c_min_dur(float): smallest nominal cover because of environmental effects [mm]
        Returns:
    ...
    def calculate_d(self,height: float, cnom: float, bar_diameter: float,
        ...
        Returns:
            d(float):  distance from top to reinforcement, or opposite, depending on the 
            reinforcement placement [mm]
        '''
